...
public class ExamSubjectEditActivity extends AppCompatActivity implements PostExamSubjectView {
    ...
    public void initView(){
        titleEditTextView = findViewById(R.id.title_et_js);
        contentEditTextView = findViewById(R.id.content_et_js);
